    ...
    >
      ...
      <div className="w-full flex items-stretch">
        ...
        {!isValid && validationMessage && (
          <Tooltip>
            <TooltipTrigger render={<div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center" />} nativeButton={false}><AlertCircle className="size-3.5 text-destructive" /></TooltipTrigger>
            <TooltipContent>
