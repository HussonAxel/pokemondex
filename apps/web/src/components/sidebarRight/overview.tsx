    ...
    <div className="flex flex-col gap-6 px-4 py-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="group relative flex flex-col items-center justify-center ring ring-1 ring-accent rounded-md py-2 cursor-pointer hover:bg-accent/10">
              ...
              abilities.map((ability, index) => {
                ...
                return (
                  <Tooltip key={`${abilityName}-${index}`}>
                    <TooltipTrigger
                      className={cn(
                        "group relative flex flex-col items-center justify-center ring ring-1 ring-accent rounded-md py-2 cursor-pointer hover:bg-accent/10",
                      )}
                    >
                      <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground/70 mb-1.5 relative z-10">
